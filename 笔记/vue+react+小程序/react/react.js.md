...
> 这是基于《千锋HTML5就业班第三阶段教学大纲V12.0》编写的react部分的授课思路及知识点剖析，欢迎各位老师指正。
>
> *--Leo zhou*
...
- HashRouter和BrowserRouter的区别，前端路由和后端路由的区别。这个在Vue里应该有讲过了。
  ...
  ​	ashHistory 使用 URL 中的 hash（#）部分去创建路由，举例来说，用户访问http://www.example.com/，实际会看到的是http://www.example.com/#/。
