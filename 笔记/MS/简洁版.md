[简版](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html)

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#一、css相关)一、CSS相关

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_1-1-左边定宽，右边自适应方案：float-margin，float-calc)1.1 左边定宽，右边自适应方案：float + margin，float + calc
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_1-2-左右两边定宽，中间自适应：float，float-calc-圣杯布局（设置bfc，margin负值法），flex)1.2 左右两边定宽，中间自适应：float，float + calc, 圣杯布局（设置BFC，margin负值法），flex
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_1-3-左右居中)1.3 左右居中
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_1-4-上下垂直居中)1.4 上下垂直居中
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_1-5-盒模型：content（元素内容）-padding（内边距）-border（边框）-margin（外边距）)1.5 盒模型：content（元素内容） + padding（内边距） + border（边框） + margin（外边距）
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_1-6-bfc、ifc、gfc、ffc：fc（formatting-contexts），格式化上下文)1.6 BFC、IFC、GFC、FFC：FC（Formatting Contexts），格式化上下文
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#二、js-基础（es5）)二、JS 基础（ES5）

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_2-1-原型)2.1 原型

> 这里可以谈很多，只要围绕 `[[ prototype ]]` 谈，都没啥问题

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_2-2-闭包)2.2 闭包

> 牵扯作用域，可以两者联系起来一起谈

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_2-3-作用域)2.3 作用域

> 词法作用域，动态作用域

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_2-4-this)2.4 this

> 不同情况的调用，`this`指向分别如何。顺带可以提一下 `es6` 中箭头函数没有 `this`, `arguments`, `super` 等，这些只依赖包含箭头函数最接近的函数

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_2-5-call，apply，bind-三者用法和区别)2.5 call，apply，bind 三者用法和区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_2-6-变量声明提升)2.6 变量声明提升

> `js` 代码在运行前都会进行 `AST` 解析，函数申明默认会提到当前作用域最前面，变量申明也会进行提升。但赋值不会得到提升。关于 `AST` 解析，这里也可以说是形成词法作用域的主要原因

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#三、js-基础（es6）)三、JS 基础（ES6）

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_3-1-let，const)3.1 let，const

> `let` 产生块级作用域（通常配合 `for` 循环或者 `{}` 进行使用产生块级作用域），`const` 申明的变量是常量（内存地址不变）

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_3-2-promise)3.2 Promise
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_3-3-generator)3.3 Generator
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_3-4-async、await)3.4 async、await
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_3-5-amd，cmd，commonjs，es6-module：解决原始无模块化的痛点)3.5 AMD，CMD，CommonJs，ES6 Module：解决原始无模块化的痛点
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#四、框架相关)四、框架相关

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_4-1-数据双向绑定原理：常见数据绑定的方案)4.1 数据双向绑定原理：常见数据绑定的方案

- `Object.defineProperty（vue）`：劫持数据的 `getter` 和 `setter`
- 脏值检测（`angularjs`）：通过特定事件进行轮循 发布/订阅模式：通过消息发布并将消息进行订阅

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_4-2-vdom：三个-part)4.2 VDOM：三个 part
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_4-3-vue-和-react-区别)4.3 vue 和 react 区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_4-4-为什么用-vue)4.4 为什么用 vue

> 简洁、轻快、舒服

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#五、网络基础类)五、网络基础类

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_5-1-跨域)5.1 跨域
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_5-2-http-无状态无连接)5.2 http 无状态无连接
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_5-3-http-cache：就是-http-缓存)5.3 http-cache：就是 http 缓存
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_5-4-cookie-和-session)5.4 cookie 和 session
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/simply.html#_5-5-安全问题，如-xss-和-csrf)5.5 安全问题，如 XSS 和 CSRF
...
← [精华](https://blog.poetries.top/FE-Interview-Questions/docs/excellent.html)[综合](https://blog.poetries.top/FE-Interview-Questions/docs/comprehensive.html) →
