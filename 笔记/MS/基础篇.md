[基础](https://blog.poetries.top/FE-Interview-Questions/docs/base.html)

![面试经验谈--来自知乎芋头Live ](http://blog.poetries.top/img-repo/2020/01/23.png)

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#一、html、http、web综合问题)一、HTML、HTTP、web综合问题

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-前端需要注意哪些seo)1 前端需要注意哪些SEO
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-img-的title和alt有什么区别)2 ``的`title`和`alt`有什么区别

- 通常当鼠标滑动到元素上的时候显示
- `alt`是``的特有属性，是图片内容的等价描述，用于图片无法加载时显示、读屏器阅读图片。可提图片高可访问性，除了纯装饰图片外都必须设置有意义的值，搜索引擎会重点分析。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-http的几种请求方法用途)3 HTTP的几种请求方法用途
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-从浏览器地址栏输入url到显示页面的步骤)4 从浏览器地址栏输入url到显示页面的步骤
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_5-如何进行网站性能优化)5 如何进行网站性能优化
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_6-http状态码及其含义)6 HTTP状态码及其含义
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_7-语义化的理解)7 语义化的理解
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_8-介绍一下你对浏览器内核的理解？)8 介绍一下你对浏览器内核的理解？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_9-html5有哪些新特性、移除了那些元素？)9 html5有哪些新特性、移除了那些元素？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_10-html5的离线储存怎么使用，工作原理能不能解释一下？)10 `HTML5`的离线储存怎么使用，工作原理能不能解释一下？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_11-浏览器是怎么对html5的离线储存资源进行管理和加载的呢)11 浏览器是怎么对`HTML5`的离线储存资源进行管理和加载的呢
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_12-请描述一下-cookies，sessionstorage-和-localstorage-的区别？)12 请描述一下 `cookies`，`sessionStorage` 和 `localStorage` 的区别？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_13-iframe有那些缺点？)13 iframe有那些缺点？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_14-web标准以及w3c标准是什么)14 WEB标准以及W3C标准是什么?

- 标签闭合、标签小写、不乱嵌套、使用外链`css`和`js`、结构行为表现的分离

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_15-xhtml和html有什么区别)15 xhtml和html有什么区别?
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_16-doctype作用-严格模式与混杂模式如何区分？它们有何意义)16 Doctype作用? 严格模式与混杂模式如何区分？它们有何意义?
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_17-行内元素有哪些？块级元素有哪些？-空-void-元素有那些？行内元素和块级元素有什么区别？)17 行内元素有哪些？块级元素有哪些？ 空(void)元素有那些？行内元素和块级元素有什么区别？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_18-html全局属性-global-attribute-有哪些)18 HTML全局属性(global attribute)有哪些
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_19-canvas和svg有什么区别？)19 Canvas和SVG有什么区别？

- `svg`绘制出来的每一个图形的元素都是独立的`DOM`节点，能够方便的绑定事件或用来修改。`canvas`输出的是一整幅画布
- `svg`输出的图形是矢量图形，后期可以修改参数来自由放大缩小，不会失真和锯齿。而`canvas`输出标量画布，就像一张图片一样，放大会失真或者锯齿

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_20-html5-为什么只需要写)20 HTML5 为什么只需要写 <!DOCTYPE HTML>

- `HTML5` 不基于 `SGML`，因此不需要对`DTD`进行引用，但是需要`doctype`来规范浏览器的行为
- 而`HTML4.01`基于`SGML`,所以需要对`DTD`进行引用，才能告知浏览器文档所使用的文档类型

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_21-如何在页面上实现一个圆形的可点击区域？)21 如何在页面上实现一个圆形的可点击区域？

- `svg`
- `border-radius`
- 纯`js`实现 需要求一个点在不在圆上简单算法、获取鼠标坐标等等

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_22-网页验证码是干嘛的，是为了解决什么安全问题)22 网页验证码是干嘛的，是为了解决什么安全问题

- 区分用户是计算机还是人的公共全自动程序。可以防止恶意破解密码、刷票、论坛灌水
- 有效防止黑客对某一个特定注册用户用特定程序暴力破解方式进行不断的登陆尝试

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_23-viewport)23 viewport
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_24-渲染优化)24 渲染优化
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_25-meta-viewport相关)25 meta viewport相关
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_26-你做的页面在哪些流览器测试过？这些浏览器的内核分别是什么)26 你做的页面在哪些流览器测试过？这些浏览器的内核分别是什么?
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_27-div-css的布局较table布局有什么优点？)27 div+css的布局较table布局有什么优点？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_28-a：img的alt与title有何异同？b：strong与em的异同？)28 a：img的alt与title有何异同？b：strong与em的异同？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_29-你能描述一下渐进增强和优雅降级之间的不同吗)29 你能描述一下渐进增强和优雅降级之间的不同吗
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_30-为什么利用多个域名来存储网站资源会更有效？)30 为什么利用多个域名来存储网站资源会更有效？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_31-简述一下src与href的区别)31 简述一下src与href的区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_32-知道的网页制作会用到的图片格式有哪些？)32 知道的网页制作会用到的图片格式有哪些？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_33-在css-js代码上线之后开发人员经常会优化性能，从用户刷新网页开始，一次js请求一般情况下有哪些地方会有缓存处理？)33 在css/js代码上线之后开发人员经常会优化性能，从用户刷新网页开始，一次js请求一般情况下有哪些地方会有缓存处理？

> `dns`缓存，`cdn`缓存，浏览器缓存，服务器缓存

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_33-一个页面上有大量的图片（大型电商网站），加载很慢，你有哪些方法优化这些图片的加载，给用户更好的体验。)33 一个页面上有大量的图片（大型电商网站），加载很慢，你有哪些方法优化这些图片的加载，给用户更好的体验。
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_34-常见排序算法的时间复杂度-空间复杂度)34 常见排序算法的时间复杂度,空间复杂度

![img](https://github.com/qiu-deqing/FE-interview/raw/master/img/sort-compare.png)

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_35-web开发中会话跟踪的方法有哪些)35 web开发中会话跟踪的方法有哪些
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_36-http-request报文结构是怎样的)36 HTTP request报文结构是怎样的
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_37-http-response报文结构是怎样的)37 HTTP response报文结构是怎样的
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#二、css部分)二、CSS部分

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-css-sprite是什么-有什么优缺点)1 css sprite是什么,有什么优缺点
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-display-none-与visibility-hidden-的区别)2 `display: none;`与`visibility: hidden;`的区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-link与-import的区别)3 `link`与`@import`的区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-什么是fouc-如何避免)4 什么是FOUC?如何避免

- `Flash Of Unstyled Content`：用户定义样式表加载之前浏览器使用默认样式显示文档，用户样式加载渲染之后再从新显示文档，造成页面闪烁。
- **解决方法**：把样式表放到文档的``

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_5-如何创建块级格式化上下文-block-formatting-context-bfc有什么用)5 如何创建块级格式化上下文(block formatting context),BFC有什么用
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_6-display、float、position的关系)6 display、float、position的关系
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_7-清除浮动的几种方式，各自的优缺点)7 清除浮动的几种方式，各自的优缺点
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_8-为什么要初始化css样式)8 为什么要初始化CSS样式?

- 因为浏览器的兼容问题，不同浏览器对有些标签的默认值是不同的，如果没对`CSS`初始化往往会出现浏览器之间的页面显示差异。
- 当然，初始化样式会对`SEO`有一定的影响，但鱼和熊掌不可兼得，但力求影响最小的情况下初始化

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_9-css3有哪些新特性)9 css3有哪些新特性
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_10-display有哪些值？说明他们的作用)10 display有哪些值？说明他们的作用
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_11-介绍一下标准的css的盒子模型？低版本ie的盒子模型有什么不同的？)11 介绍一下标准的CSS的盒子模型？低版本IE的盒子模型有什么不同的？

- 有两种， `IE`盒子模型、`W3C`盒子模型；
- 盒模型： 内容(content)、填充(`padding`)、边界(`margin`)、 边框(`border`)；
- 区 别： `IE`的c`ontent`部分把 `border` 和 `padding`计算了进去;

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_12-css优先级算法如何计算？)12 CSS优先级算法如何计算？

- 优先级就近原则，同权重情况下样式定义最近者为准
- 载入样式以最后载入的定位为准
- 优先级为: `!important > id > class > tag`; `!important` 比 内联优先级高

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_13-对bfc规范的理解？)13 对BFC规范的理解？

- 它决定了元素如何对其内容进行定位,以及与其他元素的关系和相互作用

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_14-谈谈浮动和清除浮动)14 谈谈浮动和清除浮动

- 浮动的框可以向左或向右移动，直到他的外边缘碰到包含框或另一个浮动框的边框为止。由于浮动框不在文档的普通流中，所以文档的普通流的块框表现得就像浮动框不存在一样。浮动的块框会漂浮在文档普通流的块框上

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_15-position的值，-relative和absolute定位原点是)15 position的值， relative和absolute定位原点是
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_16-display-inline-block-什么时候不会显示间隙？-携程)16 display:inline-block 什么时候不会显示间隙？(携程)
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_17-png-gif-jpg的区别及如何选)17 PNG\GIF\JPG的区别及如何选
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_18-行内元素float-left后是否变为块级元素？)18 行内元素float:left后是否变为块级元素？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_19-在网页中的应该使用奇数还是偶数的字体？为什么呢？)19 在网页中的应该使用奇数还是偶数的字体？为什么呢？

- 偶数字号相对更容易和 web 设计的其他部分构成比例关系

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_20-before-和-after中双冒号和单冒号-有什么区别？解释一下这2个伪元素的作用)20 ::before 和 :after中双冒号和单冒号 有什么区别？解释一下这2个伪元素的作用

- 单冒号(`:`)用于`CSS3`伪类，双冒号(`::`)用于`CSS3`伪元素
- 用于区分伪类和伪元素

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_21-如果需要手动写动画，你认为最小时间间隔是多久，为什么？（阿里）)21 如果需要手动写动画，你认为最小时间间隔是多久，为什么？（阿里）

- 多数显示器默认频率是`60Hz`，即`1`秒刷新`60`次，所以理论上最小间隔为`1/60*1000ms ＝ 16.7ms`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_22-css合并方法)22 CSS合并方法

- 避免使用`@import`引入多个`css`文件，可以使用`CSS`工具将`CSS`合并为一个`CSS`文件，例如使用`Sass\Compass`等

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_23-css不同选择器的权重-css层叠的规则)23 CSS不同选择器的权重(CSS层叠的规则)
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_24-列出你所知道可以改变页面布局的属性)24 列出你所知道可以改变页面布局的属性

- `position`、`display`、`float`、`width`、`height`、`margin`、`padding`、`top`、`left`、`right`、`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_25-css在性能优化方面的实践)25 CSS在性能优化方面的实践

- `css`压缩与合并、`Gzip`压缩
- `css`文件放在`head`里、不要用`@import`
- 尽量用缩写、避免用滤镜、合理使用选择器

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_26-css3动画（简单动画的实现，如旋转等）)26 CSS3动画（简单动画的实现，如旋转等）
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_27-base64的原理及优缺点)27 base64的原理及优缺点

- 优点可以加密，减少了`HTTTP`请求
- 缺点是需要消耗`CPU`进行编解码

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_28-几种常见的css布局)28 几种常见的CSS布局

#### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#流体布局)流体布局
...
#### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#圣杯布局)圣杯布局
...
#### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#双飞翼布局)双飞翼布局
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_29-stylus-sass-less区别)29 stylus/sass/less区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_30-postcss的作用)30 postcss的作用
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_31-css样式（选择器）的优先级)31 css样式（选择器）的优先级
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_32-自定义字体的使用场景)32 自定义字体的使用场景

- 宣传/品牌/`banner`等固定文案
- 字体图标

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_33-如何美化checkbox)33 如何美化CheckBox

- `` 属性 `for` 和 `id`
- 隐藏原生的 ``
- `:checked + `

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_34-伪类和伪元素的区别)34 伪类和伪元素的区别

- 伪类表状态
- 伪元素是真的有元素
- 前者单冒号，后者双冒号

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_35-base64的使用)35 `base64`的使用

- 用于减少 `HTTP` 请求
- 适用于小图片
- `base64`的体积约为原图的`4/3`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_36-自适应布局)36 自适应布局

思路：

- 左侧浮动或者绝对定位，然后右侧`margin`撑开
- 使用``包含，然后靠负`margin`形成`bfc`
- 使用`flex`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_37-请用css写一个简单的幻灯片效果页面)37 请用CSS写一个简单的幻灯片效果页面
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_38-什么是外边距重叠？重叠的结果是什么？)38 什么是外边距重叠？重叠的结果是什么？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_39-rgba-和opacity的透明效果有什么不同？)39 rgba()和opacity的透明效果有什么不同？

- `rgba()`和`opacity`都能实现透明效果，但最大的不同是`opacity`作用于元素，以及元素内的所有内容的透明度，
- 而`rgba()`只作用于元素的颜色或其背景色。（设置`rgba`透明的元素的子元素不会继承透明效果！）

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_40-css中可以让文字在垂直和水平方向上重叠的两个属性是什么？)40 css中可以让文字在垂直和水平方向上重叠的两个属性是什么？

- 垂直方向：`line-height`
- 水平方向：`letter-spacing`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_41-如何垂直居中一个浮动元素？)41 如何垂直居中一个浮动元素？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_42-px和em的区别)42 px和em的区别

- `px`和`em`都是长度单位，区别是，`px`的值是固定的，指定是多少就是多少，计算比较容易。`em`得值不是固定的，并且`em`会继承父级元素的字体大小。
- 浏览器的默认字体高都是`16px`。所以未经调整的浏览器都符合: `1em=16px`。那么`12px=0.75em`, `10px=0.625em`。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_43-sass、less是什么？大家为什么要使用他们？)43 Sass、LESS是什么？大家为什么要使用他们？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_44-知道css有个content属性吗？有什么作用？有什么应用？)44 知道css有个content属性吗？有什么作用？有什么应用？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_45-水平居中的方法)45 水平居中的方法
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_46-垂直居中的方法)46 垂直居中的方法
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_47-如何使用css实现硬件加速？)47 如何使用CSS实现硬件加速？

> 硬件加速是指通过创建独立的复合图层，让GPU来渲染这个图层，从而提高性能，

- 一般触发硬件加速的`CSS`属性有`transform`、`opacity`、`filter`，为了避免2D动画在 开始和结束的时候的`repaint`操作，一般使用`tranform:translateZ(0)`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_48-重绘和回流（重排）是什么，如何避免？)48 重绘和回流（重排）是什么，如何避免？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_49-说一说css3的animation)49 说一说css3的animation
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_50-左边宽度固定，右边自适应)50 左边宽度固定，右边自适应
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_51-两种以上方式实现已知或者未知宽度的垂直水平居中)51 两种以上方式实现已知或者未知宽度的垂直水平居中
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_52-如何实现小于12px的字体效果)52 如何实现小于12px的字体效果
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#三、javascript)三、JavaScript

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-闭包)1 闭包
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-说说你对作用域链的理解)2 说说你对作用域链的理解

- 作用域链的作用是保证执行环境里有权访问的变量和函数是有序的，作用域链的变量只能向上访问，变量访问到`window`对象即被终止，作用域链向下访问变量是不被允许的
- 简单的说，作用域就是变量与函数的可访问范围，即作用域控制着变量与函数的可见性和生命周期

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-javascript原型，原型链-有什么特点？)3 JavaScript原型，原型链 ? 有什么特点？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-请解释什么是事件代理)4 请解释什么是事件代理

- 事件代理（`Event Delegation`），又称之为事件委托。是 `JavaScript` 中常用绑定事件的常用技巧。顾名思义，“事件代理”即是把原本需要绑定的事件委托给父元素，让父元素担当事件监听的职务。事件代理的原理是DOM元素的事件冒泡。使用事件代理的好处是可以提高性能
- 可以大量节省内存占用，减少事件注册，比如在`table`上代理所有`td`的`click`事件就非常棒
- 可以实现当新增子对象时无需再次对其绑定

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_5-javascript如何实现继承？)5 Javascript如何实现继承？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_7-事件模型)7 事件模型
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_8-new操作符具体干了什么呢)8 new操作符具体干了什么呢?

- 创建一个空对象，并且 `this` 变量引用该对象，同时还继承了该函数的原型
- 属性和方法被加入到 `this` 引用的对象中
- 新创建的对象由 `this` 所引用，并且最后隐式的返回 `this`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_9-ajax原理)9 Ajax原理
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_10-如何解决跨域问题)10 如何解决跨域问题?
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_30-介绍js的基本数据类型)30 介绍js的基本数据类型
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_88-是否用过-jquery-的-deferred)88 是否用过 jQuery 的 Deferred
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_89-前端面试之hybrid)89 前端面试之hybrid

> http://blog.poetries.top/2018/10/20/fe-interview-hybrid/

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_90-前端面试之组件化)90 前端面试之组件化

> http://blog.poetries.top/2018/10/20/fe-interview-component/

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_91-前端面试之mvvm浅析)91 前端面试之MVVM浅析
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_97-为什么canvas的图片为什么过有跨域问题)97 为什么`canvas`的图片为什么过有跨域问题
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#四、jquery)四、jQuery

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-你觉得jquery或zepto源码有哪些写的好的地方)1 你觉得jQuery或zepto源码有哪些写的好的地方
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-jquery-的实现原理)2 jQuery 的实现原理
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-jquery-fn-的-init-方法返回的-this-指的是什么对象)3 `jQuery.fn` 的 `init` 方法返回的 `this` 指的是什么对象

- jQuery.fn 的 init 方法 返回的 this 就是 jQuery 对象
- 用户使用 jQuery() 或 $() 即可初始化 jQuery 对象，不需要动态的去调用 init 方法

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-jquery-extend-与-jquery-fn-extend-的区别)4 jQuery.extend 与 jQuery.fn.extend 的区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_5-jquery-的属性拷贝-extend-的实现原理是什么，如何实现深拷贝)5 jQuery 的属性拷贝(extend)的实现原理是什么，如何实现深拷贝

- 浅拷贝（只复制一份原始对象的引用） `var newObject = $.extend({}, oldObject);`
- 深拷贝（对原始对象属性所引用的对象进行进行递归拷贝） `var newObject = $.extend(true, {}, oldObject);`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_6-jquery-的队列是如何实现的)6 jQuery 的队列是如何实现的
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_7-jquery-中的-bind-live-delegate-on-的区别)7 jQuery 中的 bind(), live(), delegate(), on()的区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_8-是否知道自定义事件)8 是否知道自定义事件
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_9-jquery-通过哪个方法和-sizzle-选择器结合的)9 jQuery 通过哪个方法和 Sizzle 选择器结合的

- `Sizzle` 选择器采取 `Right To Left` 的匹配模式，先搜寻所有匹配标签，再判断它的父节点
- `jQuery` 通过 `$(selecter).find(selecter);` 和 `Sizzle` 选择器结合

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_10-jquery-中如何将数组转化为-json-字符串，然后再转化回来)10 jQuery 中如何将数组转化为 JSON 字符串，然后再转化回来
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_11-jquery-一个对象可以同时绑定多个事件，这是如何实现的)11 jQuery 一个对象可以同时绑定多个事件，这是如何实现的
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_12-针对-jquery-的优化方法)12 针对 jQuery 的优化方法
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_13-jquery-的-slideup-动画，当鼠标快速连续触发-动画会滞后反复执行，该如何处理呢)13 jQuery 的 slideUp 动画，当鼠标快速连续触发, 动画会滞后反复执行，该如何处理呢

- 在触发元素上的事件设置为延迟处理：使用 `JS` 原生 `setTimeout` 方法
- 在触发元素的事件时预先停止所有的动画，再执行相应的动画事件：`$('.tab').stop().slideUp();`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_14-jquery-ui-如何自定义组件)14 jQuery UI 如何自定义组件

- 通过向 `$.widget()` 传递组件名称和一个原型对象来完成
- `$.widget("ns.widgetName", [baseWidget], widgetPrototype);`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_15-jquery-与-jquery-ui、jquery-mobile-区别)15 jQuery 与 jQuery UI、jQuery Mobile 区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_16-jquery-和-zepto-的区别？-各自的使用场景)16 jQuery 和 Zepto 的区别？ 各自的使用场景

- `jQuery` 主要目标是`PC`的网页中，兼容全部主流浏览器。在移动设备方面，单独推出 `jQuery Mobile
- `Zepto`从一开始就定`位移动设备，相对更轻量级。它的`API `基本兼容`jQuery`，但对PC浏览器兼容不理想

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_17-jquery对象的特点)17 jQuery对象的特点

- 只有 `JQuery`对象才能使用 `JQuery` 方法
- `JQuery` 对象是一个数组对象

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#五、bootstrap)五、Bootstrap

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-什么是bootstrap？以及为什么要使用bootstrap？)1 什么是Bootstrap？以及为什么要使用Bootstrap？

> `Bootstrap` 是一个用于快速开发 `Web`应用程序和网站的前端框架。`Bootstrap`是基于 `HTML`、`CSS`、`JAVASCRIPT` 的

- `Bootstrap`具有移动设备优先、浏览器支持良好、容易上手、响应式设计等优点，所以`Bootstrap`被广泛应用

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-使用bootstrap时，要声明的文档类型是什么？以及为什么要这样声明？)2 使用Bootstrap时，要声明的文档类型是什么？以及为什么要这样声明？

- 使用`Bootstrap`时，需要使用 `HTML5` 文档类型（`Doctype`）。``
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-什么是bootstrap网格系统)3 什么是Bootstrap网格系统

> `Bootstrap` 包含了一个响应式的、移动设备优先的、不固定的网格系统，可以随着设备或视口大小的增加而适当地扩展到 `12` 列。它包含了用于简单的布局选项的预定义类，也包含了用于生成更多语义布局的功能强大的混合类

- 响应式网格系统随着屏幕或视口（`viewport`）尺寸的增加，系统会自动分为最多`12`列。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-bootstrap-网格系统（grid-system）的工作原理)4 Bootstrap 网格系统（Grid System）的工作原理
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_5-对于各类尺寸的设备，bootstrap设置的class前缀分别是什么)5 对于各类尺寸的设备，Bootstrap设置的class前缀分别是什么
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_6-bootstrap-网格系统列与列之间的间隙宽度是多少)6 Bootstrap 网格系统列与列之间的间隙宽度是多少

> 间隙宽度为`30px`（一个列的每边分别是`15px`）

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_7-如果需要在一个标题的旁边创建副标题，可以怎样操作)7 如果需要在一个标题的旁边创建副标题，可以怎样操作

> 在元素两旁添加``，或者添加`.small`的`class`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_8-用bootstrap，如何设置文字的对齐方式？)8 用Bootstrap，如何设置文字的对齐方式？

- `class="text-center"` 设置居中文本
- `class="text-right"` 设置向右对齐文本
- `class="text-left"` 设置向左对齐文本

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_9-bootstrap如何设置响应式表格？)9 Bootstrap如何设置响应式表格？

> 增加`class="table-responsive"`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_10-使用bootstrap创建垂直表单的基本步骤？)10 使用Bootstrap创建垂直表单的基本步骤？

- （1）向父``元素添加`role="form"`；
- （2）把标签和控件放在一个带有`class="form-group"`的``中，这是获取最佳间距所必需的；
- （3）向所有的文本元素``、``、``添加`class="form-control"`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_11-使用bootstrap创建水平表单的基本步骤？)11 使用Bootstrap创建水平表单的基本步骤？

- （1）向父``元素添加`class="form-horizontal"`；
- （2）把标签和控件放在一个带有`class="form-group"`的``中；
- （3）向标签添加`class="control-label"`。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_12-使用bootstrap如何创建表单控件的帮助文本？)12 使用Bootstrap如何创建表单控件的帮助文本？

> 增加`class="help-block"`的`span`标签或`p`标签。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_13-使用bootstrap激活或禁用按钮要如何操作？)13 使用Bootstrap激活或禁用按钮要如何操作？

- 激活按钮：给按钮增加`.active`的`class`
- 禁用按钮：给按钮增加`disabled="disabled"`的属性

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_14-bootstrap有哪些关于的class？)14 Bootstrap有哪些关于![img]()的class？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_15-bootstrap中有关元素浮动及清除浮动的class？)15 Bootstrap中有关元素浮动及清除浮动的class？

- （1）`class="pull-left"` 元素浮动到左边
- （2）`class="pull-right"` 元素浮动到右边
- （3）`class="clearfix"` 清除浮动

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_16-除了屏幕阅读器外，其他设备上隐藏元素的class？)16 除了屏幕阅读器外，其他设备上隐藏元素的class？

> `class="sr-only"``

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_17-bootstrap如何制作下拉菜单？)17 Bootstrap如何制作下拉菜单？

- （1）将下拉菜单包裹在`class="dropdown"`的``中；
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_18-bootstrap如何制作按钮组？以及水平按钮组和垂直按钮组的优先级？)18 Bootstrap如何制作按钮组？以及水平按钮组和垂直按钮组的优先级？

- （1）用`class="btn-group"`的``去包裹按钮组；`class="btn-group-vertical"`可设置垂直按钮组。
- （2）`btn-group`的优先级高于`btn-group-vertical`的优先级。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_19-bootstrap如何设置按钮的下拉菜单？)19 Bootstrap如何设置按钮的下拉菜单？

> 在一个 `.btn-group` 中放置按钮和下拉菜单即可。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_20-bootstrap中的输入框组如何制作？)20 Bootstrap中的输入框组如何制作？

- （1）把前缀或者后缀元素放在一个带有`class="input-group"`中的``中
- （2）在该``内，在`class="input-group-addon"`的``里面放置额外的内容；
- （3）把``放在``元素的前面或后面。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_21-bootstrap中的导航都有哪些？)21 Bootstrap中的导航都有哪些？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_22-bootstrap中设置分页的class？)22 Bootstrap中设置分页的class？

- 默认的分页：`class="pagination"`
- 默认的翻页：`class="pager"`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_23-bootstrap中显示标签的class？)23 Bootstrap中显示标签的class？

> ```
> class="label"
> ```

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_24-bootstrap中如何制作徽章？)24 Bootstrap中如何制作徽章？

> ```
> 26
> ```

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_25-bootstrap中超大屏幕的作用是什么？)25 Bootstrap中超大屏幕的作用是什么？

> 设置`class="jumbotron"`可以制作超大屏幕，该组件可以增加标题的大小并增加更多的外边距

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#六、微信小程序)六、微信小程序

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-微信小程序有几个文件)1 微信小程序有几个文件
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#七、webpack相关)七、webpack相关

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-打包体积-优化思路)1 打包体积 优化思路
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-打包效率)2 打包效率
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-loader)3 Loader
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-说一下webpack的一些plugin，怎么使用webpack对项目进行优化)4 说一下webpack的一些plugin，怎么使用webpack对项目进行优化
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#八、编程题)八、编程题

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-写一个通用的事件侦听器函数)1 写一个通用的事件侦听器函数
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-如何判断一个对象是否为数组)2 如何判断一个对象是否为数组
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-冒泡排序)3 冒泡排序
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-快速排序)4 快速排序
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_5-编写一个方法-求一个字符串的字节长度)5 编写一个方法 求一个字符串的字节长度
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_6-bind的用法，以及如何实现bind的函数和需要注意的点)6 bind的用法，以及如何实现bind的函数和需要注意的点
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_7-实现一个函数clone)7 实现一个函数clone
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_8-下面这个ul，如何点击每一列的时候alert其index)8 下面这个ul，如何点击每一列的时候alert其index
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_9-定义一个log方法，让它可以代理console-log的方法)9 定义一个log方法，让它可以代理console.log的方法
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_10-输出今天的日期)10 输出今天的日期
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_11-用js实现随机选取10-100之间的10个数字，存入一个数组，并排序)11 用js实现随机选取10–100之间的10个数字，存入一个数组，并排序
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_12-写一段js程序提取url中的各个get参数)12 写一段JS程序提取URL中的各个GET参数
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_13-写一个function，清除字符串前后的空格)13 写一个`function`，清除字符串前后的空格
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_14-实现每隔一秒钟输出1-2-3-数字)14 实现每隔一秒钟输出1,2,3...数字
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_15-实现一个函数，判断输入是不是回文字符串)15 实现一个函数，判断输入是不是回文字符串
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_16、数组扁平化处理)16、数组扁平化处理
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#九、其他)九、其他

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-负载均衡)1 负载均衡
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-cdn)2 CDN

> 内容分发网络，基本思路是尽可能避开互联网上有可能影响数据传输速度和稳定性的瓶颈和环节，使内容传输的更快、更稳定。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-内存泄漏)3 内存泄漏
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-babel原理)4 babel原理
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_5-js自定义事件)5 js自定义事件
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_6-前后端路由差别)6 前后端路由差别

- 后端每次路由请求都是重新访问服务器
- 前端路由实际上只是`JS`根据`URL`来操作`DOM`元素，根据每个页面需要的去服务端请求数据，返回数据后和模板进行组合

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#十、综合)十、综合

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_1-谈谈你对重构的理解)1 谈谈你对重构的理解
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_2-什么样的前端代码是好的)2 什么样的前端代码是好的

- 高复用低耦合，这样文件小，好维护，而且好扩展。
- 具有可用性、健壮性、可靠性、宽容性等特点
- 遵循设计模式的六大原则

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_3-对前端工程师这个职位是怎么样理解的？它的前景会怎么样)3 对前端工程师这个职位是怎么样理解的？它的前景会怎么样
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_4-你觉得前端工程的价值体现在哪)4 你觉得前端工程的价值体现在哪
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_5-平时如何管理你的项目)5 平时如何管理你的项目
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#_6-组件封装)6 组件封装
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/base.html#十一、一些常见问题)十一、一些常见问题
...
[进阶](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html) →
