...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#一、js)一、JS

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_1-谈谈变量提升)1 谈谈变量提升
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#二、浏览器)二、浏览器

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_1-cookie和localsrorage、session、indexdb-的区别)1 cookie和localSrorage、session、indexDB 的区别
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_2-怎么判断页面是否加载完成？)2 怎么判断页面是否加载完成？

- `Load` 事件触发代表页面中的 `DOM`，`CSS`，`JS`，图片已经全部加载完毕。
- `DOMContentLoaded` 事件触发代表初始的 `HTML` 被完全加载和解析，不需要等待 `CSS`，`JS`，图片加载

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_3-如何解决跨域)3 如何解决跨域
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_4-什么是事件代理)4 什么是事件代理
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_5-service-worker)5 Service worker
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_6-浏览器缓存)6 浏览器缓存
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_7-浏览器性能问题)7 浏览器性能问题
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#三、webpack)三、Webpack



### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_1-优化打包速度)1 优化打包速度
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_2-babel-原理)2 Babel 原理

- 本质就是编译器，当代码转为字符串生成 `AST`，对 `AST` 进行转变最后再生成新的代码
- 分为三步：词法分析生成 `Token`，语法分析生成 `AST`，遍历 `AST`，根据插件变换相应的节点，最后把 `AST`转换为代码

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html#_3-如何实现一个插件)3 如何实现一个插件
...
← [基础篇](https://blog.poetries.top/FE-Interview-Questions/docs/base.html)[高级](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html) →
