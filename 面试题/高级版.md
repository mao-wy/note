[高级](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html)

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#一、javascript进阶)一、JavaScript进阶

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_1-内置类型)1 内置类型
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#二、浏览器)二、浏览器

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_1-事件机制)1 事件机制
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_2-跨域)2 跨域
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_3-event-loop)3 Event loop
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_4-service-worker)4 Service Worker
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_5-渲染机制)5 渲染机制
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#三、性能)三、性能

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_1-dns-预解析)1 DNS 预解析
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_2-缓存)2 缓存
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_3-使用-http-2-0)3 使用 HTTP / 2.0

- 因为浏览器会有并发请求限制，在 `HTTP / 1.1` 时代，每个请求都需要建立和断开，消耗了好几个 `RTT` 时间，并且由于 `TCP` 慢启动的原因，加载体积大的文件会需要更多的时间
- 在 `HTTP / 2.0` 中引入了多路复用，能够让多个请求使用同一个 `TCP` 链接，极大的加快了网页的加载速度。并且还支持 `Header` 压缩，进一步的减少了请求的数据大小

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_4-预加载)4 预加载
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_5-预渲染)5 预渲染
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_6-懒执行与懒加载)6 懒执行与懒加载
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_7-文件优化)7 文件优化
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_8-其他)8 其他
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#四、安全)四、安全

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_1-xss)1 XSS
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_2-csrf)2 CSRF
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_3-密码安全)3 密码安全
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#五、小程序)五、小程序

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_1-登录)1 登录
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_2-图片导出)2 图片导出
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_3-数据统计)3 数据统计
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_4-工程化)4 工程化
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_5-小程序架构)5 小程序架构
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_6-wxml-wxss)6 WXML && WXSS
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_7-小程序的问题)7 小程序的问题
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_8-授权获取用户信息流程)8 授权获取用户信息流程
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_9-性能优化)9 性能优化
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_10-wepy-vs-mpvue)10 wepy vs mpvue
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_11-mpvue)11 mpvue
...
- 另外个问题在于小程序的 `Virtual DOM` 怎么生成？也就是怎么将 `template`编译成`render function`。这当中还涉及到运行时-编译器-vs-只包含运行时，显然如果要提高性能、减少包大小、输出 `wxml`、`mpvue` 也要提供预编译的能力。因为要预输出 `wxml` 且没法动态改变 `DOM`，所以动态组件，自定义 `render`，和``字符串模版等都不支持
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#六、react)六、React

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_1-react-中-keys-的作用是什么？)1 React 中 keys 的作用是什么？

> `Keys`是 `React` 用于追踪哪些列表中元素被修改、被添加或者被移除的辅助标识

- 在开发过程中，我们需要保证某个元素的 `key` 在其同级元素中具有唯一性。在 `React Diff` 算法中`React` 会借助元素的 `Key` 值来判断该元素是新近创建的还是被移动而来的元素，从而减少不必要的元素重渲染。此外，React 还需要借助 `Key` 值来判断元素与本地状态的关联关系，因此我们绝不可忽视转换函数中 `Key` 的重要性

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_2-传入-setstate-函数的第二个参数的作用是什么？)2 传入 setState 函数的第二个参数的作用是什么？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_3-react-中-refs-的作用是什么)3 React 中 refs 的作用是什么

- `Refs` 是 `React` 提供给我们的安全访问 `DOM`元素或者某个组件实例的句柄
- 可以为元素添加`ref`属性然后在回调函数中接受该元素在 `DOM` 树中的句柄，该值会作为回调函数的第一个参数返回

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_4-在生命周期中的哪一步你应该发起-ajax-请求)4 在生命周期中的哪一步你应该发起 AJAX 请求
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_5-shouldcomponentupdate-的作用)5 shouldComponentUpdate 的作用

> `shouldComponentUpdate` 允许我们手动地判断是否要进行组件更新，根据组件的应用场景设置函数的合理返回值能够帮我们避免不必要的更新

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_6-如何告诉-react-它应该编译生产环境版)6 如何告诉 React 它应该编译生产环境版

> 通常情况下我们会使用 `Webpack` 的 `DefinePlugin` 方法来将 `NODE_ENV` 变量值设置为 `production`。编译版本中 `React`会忽略 `propType` 验证以及其他的告警信息，同时还会降低代码库的大小，`React` 使用了 `Uglify` 插件来移除生产环境下不必要的注释等信息

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_7-概述下-react-中的事件处理逻辑)7 概述下 React 中的事件处理逻辑

> 为了解决跨浏览器兼容性问题，`React` 会将浏览器原生事件（`Browser Native Event`）封装为合成事件（`SyntheticEvent`）传入设置的事件处理器中。这里的合成事件提供了与原生事件相同的接口，不过它们屏蔽了底层浏览器的细节差异，保证了行为的一致性。另外有意思的是，`React` 并没有直接将事件附着到子元素上，而是以单一事件监听器的方式将所有的事件发送到顶层进行处理。这样 `React` 在更新 `DOM` 的时候就不需要考虑如何去处理附着在 `DOM` 上的事件监听器，最终达到优化性能的目的

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_8-createelement-与-cloneelement-的区别是什么)8 createElement 与 cloneElement 的区别是什么

> ```
> createElement` 函数是 JSX 编译之后使用的创建 `React Element` 的函数，而 `cloneElement` 则是用于复制某个元素并传入新的 `Props
> ```

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_9-redux中间件)9 redux中间件
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_10-redux有什么缺点)10 redux有什么缺点

- 一个组件所需要的数据，必须由父组件传过来，而不能像`flux`中直接从`store`取。
- 当一个组件相关数据更新时，即使父组件不需要用到这个组件，父组件还是会重新`render`，可能会有效率影响，或者需要写复杂的`shouldComponentUpdate`进行判断。

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_11-react组件的划分业务组件技术组件？)11 react组件的划分业务组件技术组件？

- 根据组件的职责通常把组件分为UI组件和容器组件。
- UI 组件负责 UI 的呈现，容器组件负责管理数据和逻辑。
- 两者通过`React-Redux` 提供`connect`方法联系起来

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_12-react生命周期函数)12 react生命周期函数
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_13-react性能优化是哪个周期函数)13 react性能优化是哪个周期函数
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_14-为什么虚拟dom会提高性能)14 为什么虚拟dom会提高性能
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_15-diff算法)15 diff算法?
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_16-react性能优化方案)16 react性能优化方案

- 重写`shouldComponentUpdate`来避免不必要的dom操作
- 使用 `production` 版本的`react.js`
- 使用`key`来帮助`React`识别列表中所有子组件的最小变化

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_16-简述flux-思想)16 简述flux 思想
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_17-说说你用react有什么坑点？)17 说说你用react有什么坑点？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_18-我现在有一个button，要用react在上面绑定点击事件，要怎么做？)18 我现在有一个button，要用react在上面绑定点击事件，要怎么做？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_19-react-的虚拟dom是怎么实现的)19 react 的虚拟dom是怎么实现的
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_20-react-的渲染过程中，兄弟节点之间是怎么处理的？也就是key值不一样的时候)20 react 的渲染过程中，兄弟节点之间是怎么处理的？也就是key值不一样的时候
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_21-那给我介绍一下react)21 那给我介绍一下react
...
## [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#七、vue)七、Vue

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_1-对于mvvm的理解)1 对于MVVM的理解
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_2-请详细说下你对vue生命周期的理解)2 请详细说下你对vue生命周期的理解
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_3-vue实现数据双向绑定的原理：object-defineproperty)3 Vue实现数据双向绑定的原理：Object.defineProperty()
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_4-vue组件间的参数传递)4 Vue组件间的参数传递
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_5-vue的路由实现：hash模式-和-history模式)5 Vue的路由实现：hash模式 和 history模式
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_5-vue路由的钩子函数)5 vue路由的钩子函数
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_6-vuex是什么？怎么使用？哪种功能场景使用它？)6 vuex是什么？怎么使用？哪种功能场景使用它？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_7-v-if-和-v-show-区别)7 v-if 和 v-show 区别

- 答：`v-if`按照条件是否渲染，`v-show`是`display`的`block`或`none`；

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_8-route和-router的区别)8 `$route`和`$router`的区别

- `$route`是“路由信息对象”，包括`path`，`params`，`hash`，`query`，`fullPath`，`matched`，`name`等路由信息参数。
- 而`$router`是“路由实例”对象包括了路由的跳转方法，钩子函数等

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_9-如何让css只在当前组件中起作用)9 如何让CSS只在当前组件中起作用?

> 将当前组件的``修改为``

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_10-keep-alive-keep-alive-的作用是什么)10 ``的作用是什么?

- `` 包裹动态组件时，会缓存不活动的组件实例,主要用于保留组件状态或避免重新渲染

> 比如有一个列表和一个详情，那么用户就会经常执行打开详情=>返回列表=>打开详情…这样的话列表和详情都是一个频率很高的页面，那么就可以对列表组件使用``进行缓存，这样用户每次返回列表的时候，都能从缓存中快速渲染，而不是重新渲染

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_11-指令v-el的作用是什么)11 指令v-el的作用是什么?

> 提供一个在页面上已存在的 `DOM`元素作为 `Vue`实例的挂载目标.可以是 CSS 选择器，也可以是一个 `HTMLElement` 实例,

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_12-在vue中使用插件的步骤)12 在Vue中使用插件的步骤

- 采用`ES6`的`import ... from ...`语法或`CommonJS`的`require()`方法引入插件
- 使用全局方法`Vue.use( plugin )`使用插件,可以传入一个选项对象`Vue.use(MyPlugin, { someOption: true })`

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_13-请列举出3个vue中常用的生命周期钩子函数)13 请列举出3个Vue中常用的生命周期钩子函数?

- `created`: 实例已经创建完成之后调用,在这一步,实例已经完成数据观测, 属性和方法的运算, `watch/event`事件回调. 然而, 挂载阶段还没有开始, `$el`属性目前还不可见
- `mounted`: `el`被新创建的 `vm.$el` 替换，并挂载到实例上去之后调用该钩子。如果 `root` 实例挂载了一个文档内元素，当 `mounted`被调用时 `vm.$el` 也在文档内。
- `activated`: `keep-alive`组件激活时调用

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_14-vue-cli-工程技术集合介绍)14 vue-cli 工程技术集合介绍
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_15-nexttick)15 NextTick

> ```
> nextTick`可以让我们在下次 DOM 更新循环结束之后执行延迟回调，用于获得更新后的 `DOM
> ```

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_16-vue的优点是什么？)16 vue的优点是什么？

- 低耦合。视图（`View`）可以独立于`Model`变化和修改，一个`ViewModel`可以绑定到不同的`"View"`上，当View变化的时候Model可以不变，当`Model`变化的时候`View`也可以不变
- 可重用性。你可以把一些视图逻辑放在一个`ViewModel`里面，让很多`view`重用这段视图逻辑
- 可测试。界面素来是比较难于测试的，而现在测试可以针对`ViewModel`来写

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_17-路由之间跳转？)17 路由之间跳转？
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_18-实现-vue-ssr)18 实现 Vue SSR

![img](http://7xq6al.com1.z0.glb.clouddn.com/vue-ssr.jpg)
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_19-vue-组件-data-为什么必须是函数)19 Vue 组件 data 为什么必须是函数

- 每个组件都是 `Vue` 的实例。
- 组件共享 `data` 属性，当 `data` 的值是同一个引用类型的值时，改变其中一个会影响其他

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_20-vue-computed-实现)20 Vue computed 实现
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_21-vue-complier-实现)21 Vue complier 实现
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_22-怎么快速定位哪个组件出现性能问题)22 怎么快速定位哪个组件出现性能问题

> 用 `timeline` 工具。 大意是通过 `timeline` 来查看每个函数的调用时常，定位出哪个函数的问题，从而能判断哪个组件出了问题

## [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#八、框架通识)八、框架通识

### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_1-mvvm)1 MVVM
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_2-路由原理)2 路由原理
...
### [#](https://blog.poetries.top/FE-Interview-Questions/docs/advance.html#_3-virtual-dom)3 Virtual Dom
...
← [进阶](https://blog.poetries.top/FE-Interview-Questions/docs/improve.html)[通识](https://blog.poetries.top/FE-Interview-Questions/docs/computed-base.html) →
